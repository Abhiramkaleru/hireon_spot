...
const deleteApplication = async (id, user_id) => {
    return db.execute("DELETE FROM applied_jobs WHERE id = ? AND user_id = ?", [id, user_id]);
};
...
module.exports = { applyJob, updateApplication, getApplicationsByJob, deleteApplication,getAppliedJobsByUser };
