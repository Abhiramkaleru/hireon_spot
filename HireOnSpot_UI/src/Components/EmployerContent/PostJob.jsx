...
const PostJob = () => {
  ...
  const onFinish = (values) => {
    // Convert hiring_team_linkedin to an array if it contains multiple URLs
    if (values.hiring_team_linkedin) {
      values.hiring_team_linkedin = values.hiring_team_linkedin
        .split(",")
        .map((link) => link.trim());
    }
  ...
  return (
    <div className="max-w-lg w-full mx-auto bg-white p-4 md:p-6 rounded-xl shadow-md">
      ...
      <Form name="jobPosting" layout="vertical" onFinish={onFinish} initialValues={{ mode: "walkin" }}>
        {/* Job Title */}
        <Form.Item label="Job Title" name="title" rules={[{ required: true, message: "Please enter the job title!" }]}>
        ...
        {/* Location */}
        <Form.Item label="Location" name="location" rules={[{ required: true, message: "Please enter the job location!" }]}>
        ...
        {/* Mode */}
        <Form.Item label="Job Mode" name="mode" rules={[{ required: true, message: "Please select a job mode!" }]}>
          <Select className="w-full">
            <Select.Option value="walkin">Walk-in</Select.Option>
            <Select.Option value="offline">Offline</Select.Option>
        ...
        {/* HR Name */}
        <Form.Item label="HR Name" name="hr_name" rules={[{ required: true, message: "Please enter the HR name!" }]}>
          <Input placeholder="HR Name" className="w-full" />
        </Form.Item>
        ...
        <Form.Item
          ...
          rules={[{ required: true, message: "Please enter HR's LinkedIn profile URL!" }]}
        >
          <Input placeholder="Enter HR LinkedIn URL" className="w-full" />
        </Form.Item>
        ...
        <Form.Item
          ...
          rules={[{ required: true, message: "Please enter the company LinkedIn profile URL!" }]}
        >
          <Input placeholder="Enter Company LinkedIn URL" className="w-full" />
        </Form.Item>
        ...
        <Form.Item
          label="Hiring Team LinkedIn"
          name="hiring_team_linkedin"
          rules={[{ required: true, message: "Please enter the hiring team's LinkedIn profile URLs (comma-separated)!" }]}
        >
          <Input placeholder="Enter multiple LinkedIn URLs, separated by commas" className="w-full" />
        </Form.Item>
